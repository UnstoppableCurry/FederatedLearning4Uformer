...
class Options():
    ...
    def init(self, parser): 
        ...
        # global settings
        parser.add_argument('--batch_size', type=int, default=2, help='batch size')##默认为32
        parser.add_argument('--nepoch', type=int, default=1000, help='training epochs')##默认为250
        ...
        parser.add_argument('--pretrain_weights',type=str, default='/home/hyzb/user_wanghongzhou/SR/log/Uformer32/models/model_best.pth', help='path of pretrained_weights')
        ...
        # args for saving 
        parser.add_argument('--save_dir', type=str, default ='/home/hyzb/user_wanghongzhou/SR/log1',  help='save dir')
        ...
        parser.add_argument('--train_dir', type=str, default ='/home/hyzb/user_wanghongzhou/SR/datasets/train',  help='dir of train data')#'./datasets/train'
        parser.add_argument('--val_dir', type=str, default ='/home/hyzb/user_wanghongzhou/SR/datasets/val',  help='dir of train data')#'./datasets/val'

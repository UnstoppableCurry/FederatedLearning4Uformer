...
if __name__ == '__main__':
    ...
    # parser.add_argument('--result_dir', default='/home/hyzb/user_wanghongzhou/SR/results/denoising/',
    parser.add_argument('--result_dir', default='./results/denoising/',
        type=str, help='Directory for results')##输出结果的目录
    parser.add_argument('--weights', default='num_comm_1500_client_16_gpuclient_4_batchsize_14_nepoch_1_IID_False_Neo等差_warmup_True/test_num_comm1199_E1_B14_lr0.0002_num_clients16_cf0.25.pt',#model_latest

    # parser.add_argument('--weights', default='/home/hyzb/user_wanghongzhou/SR/log/Uformer_32_0701_1/models/model_epoch_450.pth',#model_latest

...
if __name__ == '__main__':
    ...
    # parser.add_argument('--weights', default='/home/hyzb/user_wanghongzhou/SR/log/Uformer_32_0701_1/models/model_epoch_500.pth',#model_latest
